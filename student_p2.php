 ...
 <script>
  ...
  <div class="row">
    <div class="col-md-1 text-right">
      <a type="button" class="btn btn-info" href="rms.php?page=Students2" ><i class="fa fa-chevron-circle-left" aria-hidden="true"></i> Back</a>
    </div>
    </div>
    <div class="row">
    <div class="col-md-4">
    ...
    <div class="col-md-4">
    <?php include 'update_student2.php'; ?>
    </div>
    <div class="col-md-4">
    </div>
    </div>
    ...
    $sql = mysqli_query($conn, "SELECT * From student_info2 left join program on student_info2.PROGRAM=program.PROGRAM_ID where STUDENT_ID = '$id' ");
