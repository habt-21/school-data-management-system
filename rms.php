...
<head>
    ...
    <title>Jimma Preparatory School Data Management System</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href=""><b>&nbsp;&nbsp;&nbsp; JIMMA PREPARATORY SCHOOL DATA MANAGEMENT SYSTEM</b></a>
            </div>
            <!-- Top Menu Items -->
...
$page = $_GET['page'];
$pages = array('home', 'Students', 'Students2','subjects','student_p','student_p2','records','record','addrecord','report','report2','program','statistical','form137','form137staff','Staff_history','list_report','student_report','users','school_year','grade','advisers','database','candidates','candidates_list', 'candidates_report','logs');
if (!empty($page)) {
